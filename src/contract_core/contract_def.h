...
#define TickDeriv_CONTRACT_INDEX 19
#define CONTRACT_INDEX TickDeriv_CONTRACT_INDEX
#define CONTRACT_STATE_TYPE TickDerivState
#define CONTRACT_STATE2_TYPE TickDerivState2
#include "contracts/TickDeriv.h"
...
constexpr struct ContractDescription
{
    ...
    {"TICKDRV", 200, 10000, sizeof(TickDerivState)}, // TickDeriv binary options platform
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
...
static void initializeContracts()
{
    ...
    REGISTER_CONTRACT_FUNCTIONS_AND_PROCEDURES(TickDeriv);
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
